...
class PhilosopherTable {
	...
	private int leftForkNumber(int philosopherId) {
		return philosopherId;
	}

	private int rightForkNumber(int philosopherId) {
		return (philosopherId + 1) % nofPhilosophers;
	}

	public int firstFork(int philosopherId) {
		return Math.min(leftForkNumber(philosopherId), rightForkNumber(philosopherId));
	}

	public int secondFork(int philosopherId) {
		return Math.max(leftForkNumber(philosopherId), rightForkNumber(philosopherId));
	}
